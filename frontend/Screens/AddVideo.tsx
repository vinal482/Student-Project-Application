...
type AddVideoProps = NativeStackScreenProps<RootStackParamList, 'AddVideo'>;

const AddVideo = ({route}: AddVideoProps) => {
  const {
    courseId,
    courseName,
    topicId,
  ...
  const handleSubmit = async () => {
    ...
    const response = await axios.post(`http://10.200.6.190:8080/addVideo`, {
      courseId: courseId,
      topicId: topicid,
      name: VideoName,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.subContainer}>
        ...
        <View style={styles.courseContainer}>
          <Text style={styles.title}>Add a new video</Text>
          <>
            {topicAvailable === 1 ? (
              <>
            ...
            <Text style={styles.courseContainerTitle}>Video title*</Text>
            <TextInput
              style={styles.input}
            ...
            <TextInput
              ...
              maxLength={500}
            />
            <Text style={styles.courseContainerTitle}>Youtube Video URL*</Text>
            <TextInput
              style={styles.input}
